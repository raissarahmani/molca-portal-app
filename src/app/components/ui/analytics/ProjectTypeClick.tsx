  ...
  useEffect(() => { 
    const fetchData = async () => {
      try {
        ...
        const res = await fetch(`${apiUrl}/analytics/view-project/type?range=${value || "daily"}`, {
          method: "GET",
          headers: {
  ...
  return (
    <div className="p-5">
      <div className="w-full">
        <p className="font-semibold text-[var(--color-grey)] text-center">Project Visit By Type</p>
